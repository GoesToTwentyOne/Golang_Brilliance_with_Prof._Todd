...
import (
	"fmt"
	vero "pkg/mod/github.com/GoesToTwentyOne/HonorableTodd_udemy_Golang_practice/codesamples/27_Reinforce_revision_section_30-50/13_section_28-30/06_EBT_practice/verocellstring"
	"strings"
)
